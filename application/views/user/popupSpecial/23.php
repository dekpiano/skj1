...
<head>
    <meta charset="UTF-8">
    <title>โรงเรียนสวนกุหลาบวิทยาลัย (จิรประวัติ) นครสวรรค์</title>
    ...
    <meta NAME="copyright" CONTENT = "Dekpiano">
    <meta property="og:image" content="https://skj.ac.th/uploads/logo/LogoSKJ_4.png" />
    <!-- Favicons -->
...
body {
    ...
    background-image: url(uploads/video/bg-r5_23.webp);
...
<div class="con-video">
        <video playsinline="playsinline" autoplay="autoplay" muted="muted" loop="loop" class="video-con">
            <source src="<?=base_url('uploads/video/23.mp4')?>" type="video/mp4">
        </video>
    </div>
    
    <div id="main" class="container-fluid">
        <div class="row">
            <div class="col-md-4 order-md-1 text-center align-self-center " data-aos="zoom-in-down" data-aos-delay="50"
                data-aos-offset="200" data-aos-duration="500">
                <img class="img-fluid" src="<?=base_url('uploads/video/r5-23.png')?>" alt="">
            </div>
            <div class="col-md-8 order-1 text-center align-self-center">
                <div class="box-all">
                    <h2 data-aos="zoom-in" data-aos-delay="500">  น้อมรำลึก ในพระมหากรุณาธิคุณ
พระบาทสมเด็จพระจุลจอมเกล้าเจ้าอยู่หัว
                    ...
                    <p class="logo-r" data-aos="zoom-in-up" data-aos-delay="1000" data-aos-easing="ease-out-cubic"
                        ...
                        <h1 data-aos="zoom-in-up" data-aos-delay="1000" data-aos-easing="ease-out-cubic"
                            data-aos-duration="2000">วันปิยมหาราช <br>23 ตุลาคม 2563</h1>
                    </p>
