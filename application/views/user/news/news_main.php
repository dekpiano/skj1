			...
			<div class="row">
	            ...
	            <div class="col-md-6 col-sm-6  col-lg-4 mb-3 animated fadeInUp">
	              ...
	              <div class="card mb-4 box-shadow h-100">
	                ...
	                <?php else: ?>
	                	<img class="card-img-top" src="<?=base_url('uploads/news/').$v_news->news_img;?>" style="height: 225px; width: 100%; display: block;">
	            	<?php endif; ?>
	                <div class="card-body">
	                 ...
	                 <!--  <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p> -->
	                  <div class="d-flex justify-content-between align-items-center">
	                    <div class="btn-group">
	                      <button type="button" class="btn btn-sm btn-outline-secondary"> <i class="icofont-eye-alt"> <?=$v_news->news_view;?></i></button>
	                      <button type="button" class="btn btn-sm btn-outline-secondary"><?=$v_news->news_category;?></button>
	                    </div>
	                    <small class="text-muted"><?php echo $time_elapsed = $this->timeago->timeAgo_T($v_news->news_date); ?></small>
	                  </div>
	                </div>
	              </div>
	               </a>
