...
<section class="section" style="background: #202c62;">
    <div class="container">
        <div class="my-3 p-3 bg-white rounded shadow-sm">
            <h4 class="border-bottom border-gray pb-2 mb-0">รายชื่อนักเรียน ตามกลุ่มเรียน (Covid-19) ปี 63 </h4>
            <?php for ($i=1; $i <= 6 ; $i++) : ?>
        ...
        <div class="my-3 p-3 bg-white rounded shadow-sm">
            <h4 class="border-bottom border-gray pb-2 mb-0">รายชื่อนักเรียน (ชั้นตามปกติ) ปี 63</h4>
            <div class="media text-muted pt-3">
                <p class="media-body pb-3 mb-0  lh-125 border-bottom border-gray">
                    <a href="<?=base_url('uploads/document/บริหารวิชาการ/รายชื่อนักเรียน/รายชื่อนักเรียน-ม.1-6-ตามชั้นเรียนปกติ-1-2563.pdf');?>"
                        target="_blank" rel="noopener noreferrer">
                        <strong class="d-block text-gray-dark"><i class="icofont-download"></i> รายชื่อนักเรียน ม.1 - ม.6 ตามชั้นเรียนปกติ</strong>
                    </a>
