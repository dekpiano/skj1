            ...
            <div class="col-md-12">
                <div class="full center">
                    <div class="heading_main text_align_center text-center">
                        ...
                        <h2><span class="theme_color">ตรวจสอบและแก้ไขข้อมูลการสมัครเรียน </span>ปีการศึกษา <?=(date('Y')+543);?>
                        </h2>
    ...
    <div class="card">
        <div class="card-body">
                ...
                <form class="needs-validation" enctype="multipart/form-data" method="post" novalidate=""
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input  <?=@$readonly;?> type="text" class="form-control" id="recruit_idCard" name="recruit_idCard" required
            ...
            ?>
                    ...
                    <div class="mb-3">
                        <label for="">อัพโหลดรูปถ่าย (รูปถ่ายหน้าตรงชุดนักเรียน) <span class="badge badge-primary" 
...
<div <?=@$none;?>>
                  ...
                  foreach ($AtpyeRoom as $key => $v_AtpyeRoom) : ?>
                    ...
                    <hr class="mb-4">
                    <button class="btn btn-primary btn-lg btn-block" type="submit">ยืนยันการแก้ไขสมัครเรียน</button>
                </form>
            </div>
        </div>
    </div>
