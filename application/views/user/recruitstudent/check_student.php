                ...
                <div class="row justify-content-center pt-5">
                    ...
                    <form class="card card-sm needs-validation" novalidate="" method="get"
                        ...
                        <div class="card-body row no-gutters align-items-center">
                            ...
                            <!--end of col-->
                            <div class="col">
                                <input class="form-control form-control-lg form-control-borderless " name="search_stu"
                                    type="text" placeholder="ระบุ เลขประจำตัวประชาชน"
                                    value="<?=@$stu->recruit_idCard == '' ? '' : $stu->recruit_idCard ?>" required
