...
<div class="d-none d-md-block d-lg-block d-lg-none">
    <div class="list-group mt-2 ">
        ...
        <a href="<?=base_url('Admissions/RegStudent?a=2');?>"
            class="list-group-item list-group-item-action   <?=$active == 2 ? 'active' : ''?>">
            <i class="icofont-contact-add"></i> สมัครเรียน
        </a>
        <a href="<?=base_url('checkRegister?a=3');?>"
            class="list-group-item list-group-item-action <?=$active == 3 ? 'active' : ''?>">
            <i class="icofont-ui-edit"></i>
            ตรวจสอบและแก้ไขการสมัคร
        </a>
        ...
        <a href="#"
            ...
            <i class="icofont-bullhorn"></i> ประกาศรายชื่อผู้สมัครสอบ (รอบ 2)
        </a>
    </div>
...
<nav class="navbar navbar-dark bg-dark navbar-expand-sm fixed-top  d-md-none  d-xl-none d-lg-none ">
    <button class="btn-outline-success navbar-toggler" type="button" data-toggle="collapse"
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
        ...
        <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
            ...
            <div class="list-group mt-5  ">
                <a href="<?=base_url()?>" class="list-group-item list-group-item-action  text-center ">
                    กลับไปเว็บไซต์หลัก
                </a>
            </div>
        </ul>
