                            ...
                            <div id="step-6" class="p-2">
                                <div class=" mb-4" style="">
                                    <div class="card-body bg-danger text-white">
                                        ...
                                        <p class="card-text">2.รับสมัครผู้สำเร็จการศึกษา หรือกำลังศึกษาชั้นประถมศึกษา
                                            (ป.6) หรือ
                                ...
                                <div id="html_element" data-callback="onHuman"></div>
                                    <INPUT type="text" id="captcha" name="captcha" required value="" style="display:none">
                                    <div class="invalid-feedback">
