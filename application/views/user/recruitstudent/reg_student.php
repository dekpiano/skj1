    ...
    <!-- ======= Team Section ======= -->
      <div class="container">
        ...
        <div class="section-title">
          ...
          <h1>รับสมัครนักเรียนใหม่ ชั้นมัธยมศึกษาปีที่ <?php echo $this->uri->segment(2);?> </h1>
...
<div class="card">
  <div class="card-body">
        <div class="col-md-12 order-md-1">
          ...
          <form class="needs-validation " enctype="multipart/form-data" method="post" novalidate="" action="<?=base_url('control_recruitstudent/reg_insert')?>">
            ...
            <div class="row">
              ...
              <div class="col-md-2 mb-3">
                ...
                <input type="text" class="form-control" id="recruit_nationality" name="recruit_nationality"  required>
                <div class="invalid-feedback">
                  ระบุสัญชาติ
                </div>
              </div>
              <div class="col-md-2 mb-3">
                ...
                <input type="text" class="form-control" id="recruit_religion" name="recruit_religion" required>
                <div class="invalid-feedback">
                  ระบุศาสนา
                </div>
              </div>
              ...
              ที่อยู่ตามทะเบียนบ้าน      
                <div class="row">   
                   <div class="col-md-2 mb-3">
                    ...
                    <input type="text" class="form-control" id="recruit_homeNumber" name="recruit_homeNumber" required>
                     <div class="invalid-feedback">
                       ระบุเลขที่บ้าน
                      </div>
                  </div>
                  <div class="col-md-1 mb-3">
                    ...
                    <input type="text" class="form-control" id="recruit_homeGroup" name="recruit_homeGroup"  required>
                     <div class="invalid-feedback">
                       ระบุหมู่ที่
                      </div>
                  </div>
                  ...
                  <div class="col-md-2 mb-3">
                    ...
                    <input type="text" class="form-control" id="recruit_homeSubdistrict" name="recruit_homeSubdistrict"  required>
                     <div class="invalid-feedback">
                       ระบุตำบล/แขวง
                      </div>
                  </div>
                  <div class="col-md-2 mb-3">
                    ...
                    <input type="text" class="form-control" id="recruit_homedistrict" name="recruit_homedistrict"  required>
                     <div class="invalid-feedback">
                       ระบุอำเภอ/เขต
                      </div>
                  </div>
                  <div class="col-md-2 mb-3">
                    ...
                    <input type="text" class="form-control" id="recruit_homeProvince" name="recruit_homeProvince"  required>
                     <div class="invalid-feedback">
                       ระบุจังหวัด
                      </div>
                  </div>
                  <div class="col-md-2 mb-3">
                    ...
                    <input type="text" class="form-control" id="recruit_homePostcode" name="recruit_homePostcode"  required>
                     <div class="invalid-feedback">
                       ระบุรหัสไปรษณีย์
                      </div>
                  </div>
            ...
            <div class="d-block my-3">
              <div class="custom-control custom-radio">
                <input id="credit" name="recruit_tpyeRoom" type="radio" class="custom-control-input" value="ห้องเรียนความเป็นเลิศทางด้านวิชาการ (Science Match and Technology Program)" required>
                <label class="custom-control-label" for="credit">ห้องเรียนความเป็นเลิศทางด้านวิชาการ (Science Match and Technology Program)</label>
              </div>
              <div class="custom-control custom-radio">
                <input id="debit" name="recruit_tpyeRoom" type="radio" class="custom-control-input" value="ห้องเรียนความเป็นเลิศทางด้านภาษา (Chinese English Program)" required>
                <label class="custom-control-label" for="debit">ห้องเรียนความเป็นเลิศทางด้านภาษา (Chinese English Program)</label>
              </div>
              <div class="custom-control custom-radio">
                <input id="paypal" name="recruit_tpyeRoom" type="radio" class="custom-control-input" value="ห้องเรียนความเป็นเลิศทางด้านดนตรี ศิลปะ การแสดง (Preforming Art Program)" required>
                <label class="custom-control-label" for="paypal">ห้องเรียนความเป็นเลิศทางด้านดนตรี ศิลปะ การแสดง (Preforming Art Program)</label>
              </div>
              <div class="custom-control custom-radio">
                <input id="paypal1" name="recruit_tpyeRoom" type="radio" class="custom-control-input" value="ห้องเรียนความเป็นเลิศด้านการงานอาชีพ (Career Program)" required>
                <label class="custom-control-label" for="paypal1">ห้องเรียนความเป็นเลิศด้านการงานอาชีพ (Career Program)</label>
              </div>
            </div>
            <hr class="mb-4">
