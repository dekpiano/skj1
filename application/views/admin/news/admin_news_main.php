    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 ">
            <h6 class="m-0 font-weight-bold text-primary ">ตารางข้อมูล<?=$title;?> <a
                    href="<?=base_url('admin/news/add');?>" class="btn btn-primary btn-sm float-right"> <i
                ...
                <table class="table table-bordered" id="dataTable_news" width="100%" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="<?=base_url('admin/control_admin_news/delete_news/').$v_news->news_id.'/'.$v_news->news_img;?>"
