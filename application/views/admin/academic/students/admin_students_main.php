              ...
              <table class="table table-bordered" id="dataTable_students" width="100%" cellspacing="0">
                  ...
                  <?php foreach ($students as $key => $v_students) : ?>             
                    <tr>                     
                      ...
                      <td>
                        <a  href="<?=base_url('admin/academic/students/control_admin_students/edit_students/').$v_students->stu_id;?>" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i> แก้ไข</a>
                        <a  href="<?=base_url('admin/academic/students/control_admin_students/delete_students/').$v_students->stu_id;?>" class="btn btn-danger btn-sm" onClick="return confirm('ต้องการลบข้อมูลหรือไม่?')"><i class="fas fa-trash-alt"></i> ลบ</a>
                      </td>
                    </tr>
                  <?php endforeach; ?>                   
                  </tbody>
