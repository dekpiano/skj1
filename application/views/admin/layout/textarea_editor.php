...
<script>
     var editor_about = new FroalaEditor('.selector_about', {
        imageUploadParam: 'image_param',
        imageUploadMethod: 'post',
        height: 600,
        imageUploadURL: '<?= base_url('admin/control_admin_aboutschool/about_uploads'); ?>',
        imageUploadParams: {
            froala: 'true',
            _token: "csrf_token()"
        },
        events: {
            'image.removed': function($img) {
                $.ajax({
                        ...
                        // Request URL.
                        url: '<?= base_url('admin/control_admin_aboutschool/about_uploads_delete'); ?>',
