<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <?php if($this->session->userdata('status') != 'user') : ?> <div class="sidebar-heading mx-3"><?=$value;?></div>
    <?php endif; ?>
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePages<?=$k_menu?>"
            aria-expanded="true" aria-controls="collapsePages<?=$k_menu?>">
            <i class="fas fa-fw fa-folder"></i>
            <span><?=$v_menu->Amenu_name?></span>
        </a>
        <div id="collapsePages<?=$k_menu?>" class="collapse" aria-labelledby="headingPages"
