                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select class="custom-select d-block w-100"  id="pers_position"
                                            ...
                                            <?php if($action != 'insert_personnel') :?>
                                            <option <?=$v_posi->posi_id == $pers[0]->pers_position ? 'selected' : ''?>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select class="custom-select d-block w-100" id="pers_department"
                                            ...
                                            <option
                                                ...
                                                value="<?=$v_depart->depart_id?>"><?=$v_depart->depart_name?></option>
                                            <?php else: ?>
                                            <option value="<?=$v_depart->depart_id?>"><?=$v_depart->depart_name?>
                                            </option>
                                            <?php endif; ?>
                                            <?php endforeach; ?>
                                        </select>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select class="custom-select d-block w-100" id="pers_learning"
                                            ...
                                            <?php if($action != 'insert_personnel') :?>
                                            <option <?=$v_lear->lear_id == $pers[0]->pers_learning ? 'selected' : ''?>
                                                value="<?=$v_lear->lear_id?>"><?=$v_lear->lear_namethai?></option>
                                            <?php else: ?>
