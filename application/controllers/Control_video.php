...
class Control_video extends CI_Controller {
	...
	{		
        ...
        $data = $this->dataAll();
        $data['title'] = "วิดีโอ | โรงเรียนสวนกุหลาบวิทยาลัย (จิระประวัติ) นครสวรรค์";
		$data['description'] = "วีดีโอที่เกี่ยวข้องกับโรงเรียน";
		$data['video'] = $this->db->order_by('video_date','DESC')->get('tb_video')->result(); 
		$this->load->view('user/layout/header.php',$data);
		$this->load->view('user/video/video_all.php');
