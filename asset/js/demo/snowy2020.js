...
var Main = (function($) {
    return {
        ...
        countdownInit: function() {
            $('#countdown_container').countdown('2021/01/01', function(event) {
                $(this).html(event.strftime('<div class="row"><div class="col-md-3 col-3 countdown-globe">%D<div class="col-md-12 padding-none">Days</div></div>\
                        <div class="col-md-3 col-3 countdown-globe">%H<div class="col-md-12 padding-none">Hours</div></div>\
                        <div class="col-md-3 col-3 countdown-globe">%M<div class="col-md-12 padding-none">Minutes</div></div>\
                        <div class="col-md-3 col-3 countdown-globe">%S<div class="col-md-12 padding-none">Seconds</div></div></div>'));
            });
        }
    }
})($);
